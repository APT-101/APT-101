...
class SecurityEngineer:
    def __init__(self):
        self.role      = "Enterprise Cybersecurity Engineer"
        self.focus     = ["AI + Security", "Penetration Testing", "Incident Response"]
        self.mindset   = "Deep Thinking · Structural Analysis · Trend Foresight"
        self.languages = ["Python", "Go", "Bash", "PowerShell"]
        self.tools     = ["Metasploit", "Burp Suite", "Nuclei", "Cobalt Strike", "Claude"]
        self.platforms = {
            "WeChat Public":  "APT-101",
            "WeChat Video":   "Cybersec",
            "Douyin":         "Cybersec",
            "Xiaohongshu":    "Cybersec"
        }
        self.philosophy = ["Philosophy", "Economics", "Trend Analysis"]

    def __repr__(self):
        return f"[{self.role}] → AI-Augmented Security Researcher"
